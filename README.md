...
## Problem Statement
A lot of people often miss their medication doses because of work pressure. This usually happens unintentionally. However, not following prescribed medication schedules can have serious health consequences. This application has been developed to help users stick to their medication routines and reduce the chances of skipping doses.The main intention of the application is to enhance the user's treatment adherence and reduce health hazards resulting from missed doses as well as timing errors. The app would provide timely reminders and medicine checklist to assist patients in following their prescribed medication programs more closely,possibly improving health outcomes and reducing medical complications.
